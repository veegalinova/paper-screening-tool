        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            {formData.include_not_include === 'include' && (
              <div className="mb-4">
                <label className="block font-semibold mb-2">Datasets Used</label>
                <textarea
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <CheckboxGroup
              field="model_type"
              label="Model Type"
              options={['cnn', 'rnn', 'transformer', 'graph_nn', 'mlp', 'diffusion', 'hybrid', 'missing']}
            />

            <CheckboxGroup
              field="input_regions"
              label="Input Regions"
              options={['5utr', 'cds', '3utr', 'full_mrna', 'sequence_plus_structure', 'missing']}
            />
